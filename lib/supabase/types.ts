...
export type Database = {
  public: {
    Tables: {
      ...
      stripe_events: {
        Row: { id: string; event_id: string; event_type: string; status: Database["public"]["Enums"]["stripe_event_status"]; payload: Json; error_message: string | null; created_at: string; processed_at: string | null; updated_at: string };
        Insert: { id?: string; event_id: string; event_type: string; status?: Database["public"]["Enums"]["stripe_event_status"]; payload?: Json; error_message?: string | null; created_at?: string; processed_at?: string | null; updated_at?: string };
        Update: { id?: string; event_id?: string; event_type?: string; status?: Database["public"]["Enums"]["stripe_event_status"]; payload?: Json; error_message?: string | null; created_at?: string; processed_at?: string | null; updated_at?: string };
        Relationships: [];
      };
      page_sections: {
    ...
    Functions: { fulfill_stripe_order: { Args: { p_order_id: string; p_event_id: string; p_payload: Json }; Returns: Json } };
