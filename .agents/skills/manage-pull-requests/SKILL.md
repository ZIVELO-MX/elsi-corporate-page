...
- Keep the selected capture set at or below the Zipform limit of 20 files. Publish the active screenshot snapshot under the generic group name `Screenshots`.
